...
\begin{table}[H]
\centering
\caption{Best and default pipelines explored, and their performance}
\label{table_of_prominence}
\scalebox{0.7}{
\begin{tabular}{c|c|c|c|c|c|c|c} % l for left-aligned column, c for centered columns
Pipeline Version & Model & Normalize   & Feature Amount & Sample Reduction & Max Depth & Min Samples Split & Acc/MAPE \\ \hline
